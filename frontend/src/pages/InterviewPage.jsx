...
const InterviewPage = () => {
    ...
    const speakMessage = useCallback(async (message) => {
        try {
            ...
            const response = await axios.post(`${import.meta.env.VITE_BACKEND_URL}/api/synthesize`, {
                text: message,
                voiceId: 'Joanna',
                outputFormat: 'mp3'
            }, {
    ...
    useEffect(() => {
        if (!isChatStarted) {
            handleUpload("Tell me about yourself");
    ...
    const sendMessage = useCallback((messageText = null) => {
        const message = messageText || accumulatedText.trim();
        if (!message) {
                    ...
                    <div className="flex flex-col md:flex-row h-full">
                        ...
                        <div className="w-full md:w-2/3 p-6 bg-[#1E2939]">
                            <div className="flex flex-col h-full">
                                ...
                                <div className="flex-1 overflow-y-auto mb-6 space-y-4 max-h-96" ref={transcriptRef}>
